const ru = {
  ...
  homeTitle: 'Вакансии',
  homeSubtitle: 'Посмотрите открытые позиции и подайте заявку.',
  vacanciesTitle: 'Открытые вакансии',
  vacanciesSubtitle: 'Выберите вакансию и подайте заявку.',
  vacanciesEmpty: 'Пока нет вакансий.',
  details: 'Подробнее',
  descriptionLabel: 'Описание вакансии',
  vacancyInfoTitle: 'Информация о вакансии',
  vacancyDetailsTitle: 'Подробности',
  vacancyDetailsEmpty: 'Дополнительная информация не указана.',
  apply: 'Подать заявку',
  applyNow: 'Подать заявку',
  quickApplyTitle: 'Быстрая заявка',
